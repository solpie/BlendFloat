      ...
      <el-tab-pane style="width:250px">
        ...
        <el-collapse v-model="activeNames"
          ...
          <el-collapse-item title="ZRemesher"
                            name="1">
            <div>Polygons count {{ZRemesherValue}} K
              <el-button type="text"
                         @click.native='gob("ZRemesher",0)'>default</el-button>
            </div>
            <div class="block">
              <el-slider v-model="ZRemesherValue"
                         :step="1"
                         :min="1"
                         :max="20"
                         :show-tooltip="false"
            ...
            <el-input-number size="small"
                             v-model="ZRemesherValue"
                             style="width:98px" />
  
            <div>
              <el-button type="primary"
                         @click.native='gob("ZRemesher",ZRemesherValue)'>{{ZRemesherValue}}K</el-button>
              <el-button type="primary"
                         size='small'
          ...
          <el-collapse-item title="ZDynamesh"
            ...
            <el-input-number size="small"
                             v-model="ZDynameshValue"
                             style="width:158px" />
  
            <div>
              <el-button type="primary"
                         @click.native='gob("Dynamesh",ZDynameshValue)'>{{ZDynameshValue}}</el-button>
              <el-button type="primary"
                         size='small'
